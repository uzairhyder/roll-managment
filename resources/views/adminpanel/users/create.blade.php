                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('users.store')}}" method="Post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="email" class="border gray 300 shadow-sm w-1/2 rounded lg text-black" placeholder="Enter User Email" name="email"
                                       value="{{old('email')}}">
                            </div>
                            <div  class="my-3">
                                @error('email')
                            ...
                            <div class="my-3">
                                <input type="password" class="border gray 300 shadow-sm w-1/2 rounded lg text-black" placeholder="Enter User Password" name="password"
                                       value="{{old('password')}}">
                            </div>
                            <div  class="my-3">
                                @error('password')
